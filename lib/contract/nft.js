...
var NFT = /** @class */ (function () {
    ...
    NFT.prototype.initialize = function (network) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, collectionId, collectionIndex, collectionName, nftCodeBalance, nftP2pkhBalance, nftName, nftSymbol, nft_attributes, nftDescription, nftTransferTimeCount, nftIcon, file, writer;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, NFT.fetchNFTInfo(this.contract_id, network)];
                    case 1:
                        _a = _b.sent(), collectionId = _a.collectionId, collectionIndex = _a.collectionIndex, collectionName = _a.collectionName, nftCodeBalance = _a.nftCodeBalance, nftP2pkhBalance = _a.nftP2pkhBalance, nftName = _a.nftName, nftSymbol = _a.nftSymbol, nft_attributes = _a.nft_attributes, nftDescription = _a.nftDescription, nftTransferTimeCount = _a.nftTransferTimeCount, nftIcon = _a.nftIcon;
                        file = "";
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        tx.feePerKb(100)
                            .change(address)
                            .sign(privateKey);
                        return [4 /*yield*/, NFT.broadcastTXraw(tx.uncheckedSerialize(), network)];
                ...
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        tx.addOutput(new Output({
                            ...
                            .sign(privateKey)
                            .seal();
                        return [4 /*yield*/, NFT.broadcastTXraw(tx.uncheckedSerialize())];
    ...
    NFT.buildHoldScript = function (address) {
        ...
        var hold = new Script('OP_DUP OP_HASH160' + ' 0x14 0x' + pubKeyHash + ' OP_EQUALVERIFY OP_CHECKSIG OP_RETURN 0x0d 0x5631204d696e74204e486f6c64');
        return hold;
    };
