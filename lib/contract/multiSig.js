...
var Multisig = /** @class */ (function () {
    ...
    Multisig.prototype.getCombineHash = function (address) {
        var hash_from = Hash.sha256ripemd160(Hash.sha256(Script.fromASM(this.getMultisigLockScript(address)).toBuffer())).toString("hex") + "01";
        return hash_from;
    };
    ...
    Multisig.prototype.getSignatureAndPublicKeyCount = function (address) {
    ...
    Multisig.prototype.getMultisigLockScript = function (address) {
        var buf = Buffer.from(Base58.decode(address));
        var _a = this.getSignatureAndPublicKeyCount(address), signatureCount = _a.signatureCount, publicKeyCount = _a.publicKeyCount;
        if (signatureCount < 1 || signatureCount > 6) {
            throw new Error("Invalid signatureCount.");
        }
        if (publicKeyCount < 3 || publicKeyCount > 10) {
    ...
    Multisig.prototype.verifyMultisigAddress = function (pubkeys, address) {
        var hash_from_pubkeys = this.getHash(pubkeys).toString();
        var buf = Buffer.from(Base58.decode(address));
    ...
    Multisig.prototype.createMultisigWalletTransaction = function (address_from, pubkeys, signatureCount, publicKeyCount, satoshis, privateKey) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        address = this.createMultisigAddress(pubkeys, signatureCount, publicKeyCount);
                        return [4 /*yield*/, this.selectUTXOs(address_from, satoshis)];
                    case 1:
                        utxos = _a.sent();
                        tx = new Transaction();
                        lockScript = this.getMultisigLockScript(address);
