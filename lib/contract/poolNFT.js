            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        url_mainnet = "https://api.turingwallet.xyz/v1/tbc/main/ft/pool/nft/info/contract/id/".concat(contractTxid);
                        url = url_testnet;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        url_mainnet = "https://api.turingwallet.xyz/v1/tbc/main/ft/lp/unspent/by/script/hash".concat(ftlpHash);
                        url = url_testnet;
                        if (network === Networks.testnet) {
                            url = url_testnet;
                        }
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        url_mainnet = "https://api.turingwallet.xyz/v1/tbc/main/ft/lp/unspent/by/script/hash".concat(ftlpCodeHash);
                        url = url_testnet;
                        if (network === Networks.testnet) {
                            url = url_testnet;
                        }
