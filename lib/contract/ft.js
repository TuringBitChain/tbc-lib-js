...
var network = tbc.Networks.mainnet;
var version = 10;
...
var FT = /** @class */ (function () {
    ...
    FT.prototype.MintFT = function (privateKey_from, address_to) {
        return __awaiter(this, void 0, void 0, function () {
            var name, symbol, decimal, totalSupply, privateKey, amountbn, amountwriter, i, tapeAmount, nameHex, symbolHex, decimalHex, tape, tapeSize, utxo, codeScript, tx, txraw;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        name = this.name;
                        ...
                        tape = tbc.Script.fromASM("OP_FALSE OP_RETURN ".concat(tapeAmount, " ").concat(decimalHex, " ").concat(nameHex, " ").concat(symbolHex, " 4654617065"));
    ...
    FT.prototype.transfer = function (privateKey_from, address_to, amount) {
        return __awaiter(this, void 0, void 0, function () {
            var code, tape, decimal, privateKey, tapeAmountSetIn, amountbn, fttxo_1, tapeAmountSum, i, maxAmount, _a, amountHex, changeHex, utxo, tx, codeScript, tapeScript, changeCodeScript, changeTapeScript, txraw;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.fetchFtTXO(this.contractTxid, privateKey.toAddress().toString(), amountbn)];
                    case 1:
                        fttxo_1 = _b.sent();
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, tx.setInputScriptAsync({
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, this.getFTunlock(privateKey, tx, 0, fttxo_1.txId, fttxo_1.outputIndex)];
                                        case 1:
    ...
    FT.prototype.fetchFtTXO = function (contractTxid, addressOrHash, amount) {
        return __awaiter(this, void 0, void 0, function () {
            var hash, publicKeyHash, buf, url_testnet, url_mainnet, url, response, responseData, data, i, fttxo_codeScript, fttxo, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        hash = '';
                        ...
                        else if (addressOrHash.length < 40) {
                            buf = Buffer.from(bs58_1.default.decode(addressOrHash));
                            hash = buf.subarray(1, 21).toString("hex") + '01';
                        }
                        else {
    ...
    FT.prototype.fetchFtInfo = function (contractTxid) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url_testnet = "http://192.168.50.114:8080/v1/tbc/main/ft/info/contract/id/".concat(contractTxid);
    ...
    FT.prototype.mergeFT = function (privateKey_from) {
        return __awaiter(this, void 0, void 0, function () {
            var privateKey, address, contractTxid, url_testnet, url_mainnet, url, fttxo_codeScript, utxo, response, fttxo_2, i, tapeAmountSetIn, tapeAmountSum, i, _a, amountHex, changeHex, tx, codeScript, tapeScript, _loop_1, i, txraw, error_5;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        url_testnet = "http://192.168.50.114:8080/v1/tbc/main/ft/utxo/address/".concat(address, "/contract/").concat(contractTxid);
                    ...
                    case 4:
                            ...
                            return __generator(this, function (_c) {
                                switch (_c.label) {
                                    case 0: return [4 /*yield*/, tx.setInputScriptAsync({
                                            ...
                                            return __generator(this, function (_a) {
                                                switch (_a.label) {
                                                    case 0: return [4 /*yield*/, this.getFTunlock(privateKey, tx, i, fttxo_2[i].txId, fttxo_2[i].outputIndex)];
                                                    case 1:
                                                        unlockingScript = _a.sent();
                                                        return [2 /*return*/, unlockingScript];
                                                }
                        ...
                        _b.label = 5;
                    case 5:
                        if (!(i < fttxo_2.length)) return [3 /*break*/, 8];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        url_testnet = "http://192.168.50.114:8080/v1/tbc/main/ft/balance/combine/script/".concat(hash, "/contract/").concat(contractTxid);
                ...
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        for (i = 0; i < response.length; i++) {
                            if (response[i].value > 50000 && response[i].value < 3200000000) {
                                data = response[i];
                                break;
                            }
                        }
                    ...
                    case 4:
                        error_7 = _a.sent();
                        console.error("Error fetching UTXO:", error_7);
