            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        url_mainnet = "https://api.turingwallet.xyz/v1/tbc/main/tx/hex/".concat(txid);
                        url = url_testnet;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        url_mainnet = 'https://api.turingwallet.xyz/v1/tbc/main/broadcast/tx/raw';
                        url = url_testnet;
                        if (network === Networks.testnet) {
                            url = url_testnet;
                        }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        url_mainnet = "https://api.turingwallet.xyz/v1/tbc/main/ft/utxo/combine/script/".concat(hash, "/contract/").concat(contractTxid);
                        url = url_testnet;
                        if (network === Networks.testnet) {
                            url = url_testnet;
                        }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        url_mainnet = "https://api.turingwallet.xyz/v1/tbc/main/ft/info/contract/id/".concat(contractTxid);
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        url_mainnet = "https://api.turingwallet.xyz/v1/tbc/main/ft/utxo/address/".concat(address, "/contract/").concat(contractTxid);
                        url = url_testnet;
                        if (network === Networks.testnet) {
                            url = url_testnet;
                        }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        url_mainnet = "https://api.turingwallet.xyz/v1/tbc/main/ft/balance/combine/script/".concat(hash, "/contract/").concat(contractTxid);
                        url = url_testnet;
                        if (network === Networks.testnet) {
                            url = url_testnet;
                        }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        url_mainnet = "https://api.turingwallet.xyz/v1/tbc/main/address/".concat(address, "/unspent/");
                        url = url_testnet;
                        if (network === Networks.testnet) {
                            url = url_testnet;
                        }
